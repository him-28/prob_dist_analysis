...
# plotting
plot(cv_mle, type = "o", col = "blue", xlab = "Number of genes*100", ylab = "MLE vs MVR performance using CV")
lines(cv_mvr, type = "o", col = "red")
legend('topright', c("MLE cv performance","MVR cv performance"), lty=c(1,1), bty='n', lwd=c(2.5,2.5),col=c("blue","red"))
#arr <- c(cv_acc_mle, cv_acc_mvr)
#barplot(arr, main="Performance Comparison Plot", xlab="Method", ylab="Cross Validation accuray", names.arg=c("MLE", "MVR"),border="red", density=29)